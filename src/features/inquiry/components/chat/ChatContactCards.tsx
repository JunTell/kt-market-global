...
export default function ChatContactCards() {
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <span className="text-[11px] font-semibold text-black/60 leading-none mb-0.5">{t('kakao_chat')}</span>
                        <span className="text-xs font-bold text-[#191919]">{t('kakao_name')}</span>
                    </div>
                </a>
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <span className="text-[11px] font-semibold text-white/80 leading-none mb-0.5">{t('global_label')}</span>
                        <span className="text-xs font-bold text-white">{t('whatsapp_name')}</span>
                    </div>
                </a>
            </div>
        </div>
