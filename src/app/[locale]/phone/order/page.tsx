...
export default function OrderPage() {
  ...
  const fetchFromDB = async (fullModelStr: string) => {
    ...
    if (device) {
      ...
      const selectedColor = isUrlColorAvailable ? colorKey : (availableColors[0] || (device.colors_en || [])[0] || "black")
  ...
  return (
    <div className="flex flex-col gap-5 w-full max-w-[480px] mx-auto min-h-screen pb-10 bg-base">
